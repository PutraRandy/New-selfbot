...
print "==================[☆Rangers Squad Team☆]==================="
reload(sys)
sys.setdefaultencoding('utf-8')

helpmsg ="""╔════════════════════════════════
╠♧ Mymenu S3lfb0t♧
╠♧ Ini hanya buat mainan saja♧
╠♧ Ketik Help1-5 untuk comandnya♧
╠♧ Cermati dan hafalkan comandnya♧
╠♧ http://line.me/ti/p/rGlnNk8lsn♧
╠♧Jasa sewa SelfBot dan ProtectBot♧
╚════════════════════════════════
"""
...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"♧jasa pemasangan SelfBot dan ProtectBot♧",
    "lang":"JP",
    "comment":"http://line.me/ti/p/rGlnNk8lsn",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["S.R.B lagi mandi klu perlu ikutan sana"]
                     ret_ = "[Njirr tag aja luu] " + random.choice(balas)
...
#==============================================================================#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u577d79f51412f92e7a28d360ca351ae4"}
                cl.sendMessage(creator tertampan sementara..hiks)
